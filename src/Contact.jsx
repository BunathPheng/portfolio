...
export default function Contact() {
  return (
    <div>
         <div class="grid sm:grid-cols-2 items-start gap-28  mx-auto font-[sans-serif]">
          <form class="ml-auto space-y-4">
            ...
            <div>
                <h1 class="text-yellow-300   text-3xl font-extrabold">Let's Talk</h1>
                ...
                <div class="mt-12">
                    <h2 class="text-yellow-300 text-base font-bold">Email</h2>
                    <ul class="mt-4">
                        <li class="flex items-center">
                            ...
                            <a href="javascript:void(0)" class="text-slate-300 text-sm ml-4">
                                <small class="block">Mail</small>
                                <strong>bunath45@gmail.com</strong>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="mt-12">
                    <h2 class="text-yellow-300 text-base font-bold">Socials</h2>
